"""
Parse html content from existing `data/shows` folder.
Save as `all_shows.json` in the folder `data/structured`

Investigate individual shows using this link: https://www.broadwayworld.com/shows/backstage.php?showid=313359
"""
# Import the usuals
import os
import re
